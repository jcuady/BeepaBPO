  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        subtitle="Browse payroll cycles. Periods are provisioned by finance (no create UI here)."
      />
      ...
      {!periods?.length ? (
        <EmptyState
          ...
          description="Ask finance to open a period, or use seed data in demo environments."
        />
      ) : (
          ...
          {periods.map((period) => (
            ...
            >
              <CardContent className="flex flex-wrap items-center justify-between gap-3 p-4">
                <Link href={`/app/payroll/periods/${period.id}`} className="min-w-0 flex-1">
